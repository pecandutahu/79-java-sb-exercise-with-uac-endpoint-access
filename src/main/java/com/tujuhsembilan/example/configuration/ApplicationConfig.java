  ...
  public SecurityFilterChain securityConfig(HttpSecurity http, PasswordEncoder passwordEncoder, AuthProp prop)
    ...
    http
        ...
        .authorizeHttpRequests(req -> req
            ...
            .requestMatchers(new AntPathRequestMatcher("/sample/data-a/**")).hasRole("A")
            .requestMatchers(new AntPathRequestMatcher("/sample/data-b/**")).hasRole("B")
            .requestMatchers(new AntPathRequestMatcher("/sample/data-c/**")).hasAnyRole("A","B")
